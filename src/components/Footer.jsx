    ...
    <footer>
      ...
      <div className="hidden xxl:flex fixed bottom-[160px] -left-[100px] rotate-90">
        <div className="flex items-center gap-3 text-[#7c7cb3] cursor-pointer">
          <a href="https://www.linkedin.com/"><FaLinkedin size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://github.com/"><FaGithub size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://www.instagram.com/"><FaInstagram size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://itch.io/"><FaItchIo size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
